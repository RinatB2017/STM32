...
uint8_t get_address()
{
	union U_BYTE temp;
	temp.value = 0;
	temp.bites.bit0 = (GPIO_ReadInputData(GPIOA) & GPIO_Pin_7);
	temp.bites.bit1 = (GPIO_ReadInputData(GPIOA) & GPIO_Pin_9);
	temp.bites.bit2 = (GPIO_ReadInputData(GPIOA) & GPIO_Pin_10);
	temp.bites.bit3 = (GPIO_ReadInputData(GPIOA) & GPIO_Pin_13);
	temp.bites.bit4 = (GPIO_ReadInputData(GPIOA) & GPIO_Pin_14);
